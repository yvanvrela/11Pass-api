...
Revision ID: 1e8922caec0b
Revises: b6bc57c2026f
Create Date: 2022-09-23 00:28:18.465072
...
revision = '1e8922caec0b'
down_revision = 'b6bc57c2026f'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    sa.Column('secret_key', sa.String(length=30), nullable=True),
